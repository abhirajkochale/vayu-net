"""
VAYU-NET: EXP-M3 Multi-Task Loss Functions.
Implements masked multi-task loss identical to EXP-M1/M2:
  - Center localization (Smooth L1 on absolute normalized coordinates)
  - Wind speed regression (Masked Smooth L1 on standardized wind)
  - Intensity classification (Masked Cross-Entropy on 7 IMD categories)
  - Track prediction (Masked Smooth L1 at +12h, +24h, +48h on normalized coordinates)
"""
...
class MaskedMultiTaskLoss(nn.Module):
    ...
    def forward(self,
        ...
        m12 = batch["wind_12h_mask"].to(device)
        ...
        metrics = {
            ...
            "loss_wind": loss_wind.item(),
            "loss_class": loss_class.item(),
            "loss_12": loss_12.item(),
            "loss_24": loss_24.item(),
            "loss_48": loss_48.item(),
